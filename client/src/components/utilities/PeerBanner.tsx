...
const PeerBanner = ({
  ...
  return (
    <div className="h-full w-full flex px-8 items-center justify-between gap-4">
      <Dialog>
        <DialogTrigger className="h-full flex items-center p-0">
          ...
          <div className="h-full w-auto flex ml-2 flex-col gap-1 justify-center items-start">
